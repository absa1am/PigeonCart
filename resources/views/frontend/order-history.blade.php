                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">
                                              <button class="bg-transparent hover:bg-green-500 text-blue-700 font-semibold hover:text-white py-1 px-2 border border-blue-500 hover:border-transparent rounded">
                                                <a href="{{ route('view.order', ['id' => $order->id]) }}">View</a>
                                              </button>
                                                ...
                                                <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
                                                  ...
                                                  <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                                                    ...
                                                    <div class="modal-content py-4 text-left px-6">
                                                      ...
                                                      <p>Remember, deleted order, associate cart and</p>
                                                      <p>ordered product can't be restore.</p>

                                                      <!--Footer-->
                                                      <div class="flex justify-end pt-2">
                                                        <a class="px-4 bg-transparent p-3 rounded-lg text-black-500 hover:bg-red-400 hover:text-white-400 mr-2" href="">Delete</a>
