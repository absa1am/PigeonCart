            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <x-auth-card>
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('update.product', ['id' => $product->id]) }}">
                            @csrf
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="description" class="block mt-1 w-full" type="text" name="description" value="{{ $product->description }}" required />
                            </div>
