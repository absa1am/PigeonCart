                                        ...
                                        <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
                                          ...
                                          <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                                            ...
                                            <div class="modal-content py-4 text-left px-6">
                                              ...
                                              <p>Remember, deleted account, associate cart and</p>
                                              <p>ordered product can't be restore.</p>

                                              <!--Footer-->
                                              <div class="flex justify-end pt-2">
                                                <a class="px-4 bg-transparent p-3 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2" href="{{ route('delete.user', ['id' => $user->id]) }}">Delete</a>
